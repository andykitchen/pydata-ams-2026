...
# Credit slide 1 
_(Laura put on hat, andy advance slide)_

# Credit slide 2 
_(andy put on hat, laura advance slide)_

# Section 1 - science fiction
This section explores themes in science fiction around the creator/destroyer meta narrative. What does our collective subconscious already know? 

## Specific examples - major 
...
- A pivotal female protagonist (Ripley, Leeloo, Sarah Connor)
- A world-ending threat (Alien, Dark Planet/The Great Evil, Terminator)
- A highly militarised world where social connections are thin and tearing apart 
- "Good" and "Bad" technology 
- Cycles, returning to the "origin", forever war, forever struggle 

Differences 
- Spectrum between technology-as-man made (Terminator) and technology as biology (Aliens)


## Specific examples - minor 
These could be used to support the points above, glancing references, quotes, visual references etc. 
...
- Mothering as not just giving birth to but attempting to 


_Bridge_ 

"Her" as it bled into reality - hyperstition - Sam Altman - consent, control and commodification of the feminine. 


# Section 2 - data science 
This section carries the themes from section 1 to real world examples from science and technology. 

## Major topics  

- Game theory - collaboration versus competition (prisoners dilemma)
- Imperfect information games and how we operate under uncertainty 
- The story of the egg and the sperm (the story versus the science)
- OpenAI agents leak (the brew-hahah as well as the literal report, the weight of possible futures versus the risks of today)

## Minor topics 

- Playtex created the first apollo 11 spacesuit
- history of the pregnancy test (women can't be trusted to find this out on their own)
- history of birth control-as-technology 


# Section 3 - world models
This section is a synthesis of the two that came before, themes weaving together. 

_Laura and Andy exchange hats_ 

## Major topics  

- The forever singularity - always on the precipice but never inside the black hole
- Philosophy 
    - Simone de Bouvoir - ethic of ambiguity 
    - Maria Lugones - Playfulness, world travelling, loving perception 
    - Carol Gilligan - ethic of care 

- De-centering the hero, focusing on collective futures 
- Imagine/build towards the future you want  (solar punk, hope punk)
- Eudamonia - flourishing through connection & sufficiency (Dr. Thomas Tijerina)
...
No gods, no masters 
Anti hierarchy - what is the opposite of a rigid hierarchy? slime mould? chaos / entropy? 

Nature is just as vicious and dangerous as man. Evolution as a technology. 

What is a decolonised vision of happiness? 

Play, lightness, space to explore 
